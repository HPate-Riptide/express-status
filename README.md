...
Extends the [Express](http://expressjs.com/) response prototype with status codes
...
## express-status
Exports an object with status codes and extends the express request object by adding methods that will set the status code and return the request object.
